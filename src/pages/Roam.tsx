...
export default function Roam() {
  ...
  }, [lightingMode, setLightingMode, showFurniture, setShowFurniture, isMeasuring, setIsMeasuring, clearMeasurePoints]);
  ...
  return (
    <div className="h-screen w-screen bg-space-950 overflow-hidden relative">
      ...
      {!pointerLocked && (
        <div className="absolute inset-0 flex items-center justify-center bg-space-950/70 z-10">
          <div className="glass-card rounded-2xl p-8 text-center max-w-md">
            <Eye className="w-16 h-16 mx-auto mb-4 text-aurora-400" />
            <h2 className="text-2xl font-display font-bold text-gradient mb-2">进入 VR 漫游模式</h2>
            <p className="text-metal-300 mb-6">点击屏幕锁定鼠标，使用 WASD 键行走，鼠标控制视角</p>
            <button onClick={() => setShowControls(true)} className="btn-primary px-8">
              开始漫游
            </button>
          </div>
        </div>
      ...
      <div className="absolute top-24 right-6 z-20 glass-card rounded-xl p-4 w-64">
      ...
      {infoModal && (
        <div className="absolute inset-0 bg-space-950/80 flex items-center justify-center z-30">
